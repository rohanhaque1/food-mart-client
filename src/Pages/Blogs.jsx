        ...
        <div className="py-4">
          <div>
            ...
            <p className="py-4 text-base text-gray-700">
              ...
              between the two is how they handle state and user input. An
              uncontrolled component does not manage its own state. Instead, it
              relies on the DOM to store and manage its state.
            </p>
          </div>
          <div>
            ...
            <p className="py-4 text-base text-gray-700">
              ...
              exports a range of validators that can be used to make sure the
              data you receive is valid. In this example, we’re using
              PropTypes.string. When an invalid value is provided for a prop, a
              warning will be shown in the JavaScript console. For performance
          ...
          <div>
            ...
            <p className="py-4 text-base text-gray-700">
              ...
              commonly used in building web applications. However, there are
              some differences between the two. Node.js provides a runtime
